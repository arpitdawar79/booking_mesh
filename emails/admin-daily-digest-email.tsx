import { EmailFooter, EmailSection, EmailShell, themes } from "./components";
            ...
            <td>
              ...
              >
                ...
                {booking.extraMattressCount > 0
                  ? ` (+${booking.extraMattressCount} extra mattress${booking.extraMattressCount > 1 ? "es" : ""})`
                  : ""}
                &middot; {booking.adultCount} adults
                {booking.childCount > 0
                  ? `, ${booking.childCount} children`
                  : ""}{" "}
                &middot; {booking.nightCount} night
                {booking.nightCount > 1 ? "s" : ""} &middot; Meals:{" "}
                {booking.mealPlan}
              </div>
              <div
                style={{
              ...
              >
                {booking.checkInDate} {booking.checkInTime} &rarr;{" "}
                {booking.checkOutDate} {booking.checkOutTime} &middot; ID:{" "}
                {booking.bookingId}
              </div>
              {booking.specialRequests &&
                booking.specialRequests !== "None shared." && (
                  <div
                    style={{
                      color: "#8a5c3a",
                      fontFamily: "Arial, Helvetica, sans-serif",
              ...
              {booking.balanceAmount > 0 && (
                ...
                >
                  Outstanding balance: {booking.currency}{" "}
              ...
              {isCheckOut && booking.googleReviewUrl && (
                ...
                >
                  Actions: Ask for review &middot; Group photo &middot;
                  Instagram mention{" "}
