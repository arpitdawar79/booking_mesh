...
export function BookingConfirmationEmail(props: Props) {
  ...
  return (
    <EmailShell
      theme={theme}
      title="Booking Confirmation | The Stream by Ekantah"
    >
      <EmailHeader
        theme={theme}
      ...
      <EmailHero
        ...
        body={
          <>
            Thank you for choosing <strong>The Stream by Ekantah</strong> — our
            hidden 5-room boutique stay by the river in Tirthan Valley. Your
            room with its warm, bohemian touches and private balcony is ready.
          </>
        }
      />
      ...
      <EmailSection
        theme={theme}
        label="Stay Snapshot"
        title="A quiet room, river air, and time to slow down."
      >
      ...
      <EmailSection
        ...
        title="Here is what has been paid and what remains."
      >
        <table role="presentation" width="100%" cellPadding={0} cellSpacing={0}>
          <AmountRow
            theme={theme}
      ...
      <ContactBlock theme={theme} label="Questions?">
        ...
        {props.propertyPhone}. We are here to help — and we cannot wait to
        welcome you to the stream.
      </ContactBlock>
