  ...
  return (
    <html lang="en">
      <head>
        ...
        />
        <title>Notification | The Stream by Ekantah</title>
      </head>
      <body
        style={{
          margin: 0,
                ...
                >
                  ...
                  <tr>
                    ...
                    >
                      ...
                      >
                        Hello {props.guestFirstName}, we have an update for you.
                      </div>
                      <div
                        style={{
                          color: "#d9e0ec",
                      ...
                      >
                        Here is something we wanted to share about your upcoming
                        stay at The Stream by Ekantah.
                      </div>
                      <table
                        role="presentation"
                        width="100%"
                      ...
                      >
                        <tr>
                          <td style={{ padding: 22 }}>
                            ...
                            >
                              {props.customMessage ||
                                "We wanted to reach out with an important update regarding your reservation. Please read below for details."}
                            </div>
                          </td>
                        </tr>
                      </table>
