        ...
        <div className="flex items-center gap-2 flex-wrap">
          <div className="relative">
            ...
            <input
              ...
              className="pl-10 pr-3 py-2 rounded-xl border border-border/60 bg-muted/10 text-xs focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500/20 w-40 sm:w-56 transition-all"
            />
          </div>
